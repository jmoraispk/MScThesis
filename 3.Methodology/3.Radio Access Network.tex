...
% PN
The noise power $P_N$ is computed according to Expression \ref{eq:noise}, using the bandwidth of a single PRB, which depends on the numerology as evidenced in Table \ref{tab:num}.
