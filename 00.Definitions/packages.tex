...
% for ceil and floor symbols that scale properly
\usepackage{mathtools}
\DeclarePairedDelimiter\ceil{\lceil}{\rceil}
\DeclarePairedDelimiter\floor{\lfloor}{\rfloor}


% In order to include tables from tablesgenerator.com
%\usepackage[table,xcdraw]{xcolor}

\usepackage{tabto} % uhm, what's this?


% to adjust the positioning of images
